...
|--------|-------|----------------|----------|
| (none) | Base | Mobile-first default | Default styles |
| `mob:` | max-480px | 480px | Mobile-only overrides |
| `tab:` | 481px-1024px | 1024px | Tablet styles |
| `desk:` | 1025px-1600px | 1600px | Desktop styles |
| `fw:` | 1601px+ | 1601px+ | Large/full-width screens |
...
const buttonVariants = cva(
  'rounded-md font-semibold transition-colors',
  {
    variants: {
      variant: {
        primary: 'bg-purple-DEFAULT text-white',
...
## Styled-Components to Tailwind Mapping
...
| `${colors.primaryPurple}` | `bg-purple-DEFAULT` or `text-purple-DEFAULT` |
| `${colors.primaryOrange}` | `bg-orange-DEFAULT` or `text-orange-DEFAULT` |
