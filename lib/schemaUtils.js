...
export const validateSchemaMarkup = (schemaData) => {
  ...
  try {
    ...
    if (cleaned.mainEntity?.review && !Array.isArray(cleaned.mainEntity.review)) {
...
export const generateDefaultSchema = (pageData) => {
  ...
  return {
    ...
    '@type': 'WebPage',
    description: pageData?.content?.metadata?.description || 'Vasion Print Management Solutions',
    mainEntity: {
