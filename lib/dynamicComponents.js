...
export const HeavyComponents = {
  ...
  // Additional components converted to dynamic imports
  CustomerLogos: () => import('@/components/CustomerLogos'),
  LogoBanner: () => import('@/components/LogoBanner'),
  InfographicPill: () => import('@/components/InfographicPill'),
  InfographicSideBySide: () => import('@/components/InfographicSideBySide'),
  ResourceArticle: () => import('@/components/ResourceArticle'),
  ResourceAuthor: () => import('@/components/ResourceAuthor'),
  ResourceCta: () => import('@/components/ResourceCta'),
  ResourceInlineQuote: () => import('@/components/ResourceInlineQuote'),
  ResourcesTOC: () => import('@/components/ResourcesTOC'),
  ReviewBadgeCta: () => import('@/components/ReviewBadgeCta'),
  SupportedPrinters: () => import('@/components/SupportedPrinters'),
  TestForm: () => import('@/components/TestForm'),
  ThankYouComponent: () => import('@/components/ThankYouComponent'),
  // Business Case Tool components
  BCTPDF: () => import('@/components/BusinessCaseTool/BCTPDF'),
  ClientBTCResults: () =>
    import('@/components/BusinessCaseTool/ClientBTCResults'),
  PDFComponents: () => import('@/components/BusinessCaseTool/PDFComponents'),
};
...
export const CopyComponents = {
  ...
  ResourcesLongForm: () =>
    import('@/components/copyComponents/ResourcesLongForm'),
};
