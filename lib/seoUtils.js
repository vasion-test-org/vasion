 ...
 * @param {URLSearchParams} searchParams - The search parameters from the request
...
export function hasUtmParameters(searchParams) {
  ...
  return utmParams.some((param) => searchParams.has(param));
}
...
export function hasTrackingParameters(searchParams) {
  ...
  return trackingParams.some((param) => searchParams.has(param));
}
