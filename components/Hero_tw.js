...
const Hero_tw = ({ blok }) => {
  ...
  const getBackgroundStyle = () => {
    ...
    return {
      background: selectedTheme.hero.bg || '#F5F4F7',
    };
  };

  // Get text color
  const textColor =
    customTheme?.text_color?.value || selectedTheme.hero.textColor || '#1B1D21';

  // Calculate padding for HeroWrapper
  ...
  const getPaddingClasses = () => {
    ...
    // Default spacing
    if (offset === 'top') {
      return 'pt-[6vw] pb-0 px-[9.25vw] fullWidth:pt-24 fullWidth:pb-0 fullWidth:px-[148px] tablet:pt-[5.859vw] tablet:pb-0 tablet:px-[3.906vw] mobile:pt-[12.5vw] mobile:pb-0 mobile:px-[5.417vw]';
    }
    if (offset === 'bottom') {
      return 'pt-0 pb-[6vw] px-[9.25vw] fullWidth:pt-0 fullWidth:pb-24 fullWidth:px-[148px] tablet:pt-0 tablet:pb-[5.859vw] tablet:px-[3.906vw] mobile:pt-0 mobile:pb-[12.5vw] mobile:px-[5.417vw]';
    }
    return 'py-[6vw] px-[9.25vw] fullWidth:py-24 fullWidth:px-[148px] tablet:py-[5.859vw] tablet:px-[3.906vw] mobile:py-[12.5vw] mobile:px-[5.417vw]';
  };

  const getPaddingStyle = () => {
    // Custom spacing will be handled via the style tag with media queries
    return {};
  };
