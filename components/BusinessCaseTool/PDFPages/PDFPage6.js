...
const PDFPage6 = ({ savingsFormData }) => {
  ...
  return (
    <PageWrapper>
      ...
      <Text>
        Print servers aren’t just a waste of money, they're susceptible to hacks and data theft.
        Remember <Link href="https://printerlogic.com/print-nightmare/">PrintNightmare</Link>?
        Attackers had free access to attack all connected devices via specific inbound Remote
        Procedure Protocols that failed to restrict the administration of printers and related
        drivers. Since July 2021, over{' '}
        ...
        , and around 31,000 attacks happened in 2022. Falling victim to one of these vulnerabilities
        could prove costly, too. According to{' '}
        ...
        , the average cost of a print-related data breach is over $904,000 (€851,000, $1.4 million,
        £743,000). In short, print servers are still an ongoing security vulnerability that
        PrinterLogic customers do not worry about after eliminating them. Now, that is a very nice
        additional benefit!
      </Text>
      <BodyHeadline>The Impact Print Servers Have on Your Carbon Footprint</BodyHeadline>
      <Text>
        Print servers also consume energy, increasing your organization's carbon footprint.  
        <Link href="https://www.manxtechgroup.com/how-much-will-a-server-cost-uk/">
          According to Manxtech
        </Link>
        , a small server uses 5-8 kWh of power daily. One of our customers eliminated 140 print
        servers. Using the Manxtech figure, this would equate to over 216,000 kg of carbon emissions
        a year—
      ...
      <Text>
        The above table gives you an idea of the cumulative effect that print servers have on your
